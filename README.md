...
- Here they can either login or sign up to gain access to the sites features and test out our awesome editor!
  <img src="https://i.ibb.co/7r6pCZv/splash-page.jpg" alt="splash-page" border="0">
...
- A authenticated users profile page where they can view their personal information.
  <img src="https://i.ibb.co/m52wM1Q/profile-page.jpg" alt="profile-page" border="0">
...
- Where a authenticated user can view all of their created notebooks.
  <img src="https://i.ibb.co/KNhdvP1/notebooks-page.jpg" alt="notebooks-page" border="0">
...
- A modal that allows authenticated users to create new notes for a notebook.
  <img src="https://i.ibb.co/RcJVK8V/create-note-modal.jpg" alt="create-note-modal" border="0">
...
- Where authenticated users can view individually created notebooks and these notebooks notes.
  <img src="https://i.ibb.co/y8B2H70/each-notebook-page.jpg" alt="each-notebook-page" border="0">
